...
namespace Domain.Repository
{
    public class SupportRepository
    {
        ...
        public List<SupportTypeView> GetSupportTypeList()
        {
            List<SupportTypeView> list = new List<SupportTypeView>();

            foreach (KeyValuePair<int, string> item in supportTypeList)
            {
                SupportTypeView view = new SupportTypeView()
                {
        ...
        public List<Support> GetListByStatus(Enums.SupportStatus status, int page, int numberOfRow, ref int totalRecord)
        {
            List<Support> list = new List<Support>();
            IQueryable<Support> iSupport = DBContext.Context.Supports.Where(x => x.Status == (int)status)
                .OrderByDescending(x => x.CreatedDate);
        ...
        public int Insert(int userId, int serverID, string title, Enums.SupportStatus status, short supportTypeId)
        {
